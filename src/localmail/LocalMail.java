...
public class LocalMail
{
    ...
    System.out.print("Username@localmail.com: ");
    ...
    FileWriter fout=new FileWriter(User+"@localmail.com");
    ...
    FileReader fout=new FileReader(User+"@localmail.com");
    ...
    FileReader fout=new FileReader(User1+"@localmail.com");
    BufferedReader bout=new BufferedReader(fout);
